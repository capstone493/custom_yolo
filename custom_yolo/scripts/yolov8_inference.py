...
class YOLOv8ROS:
    def __init__(self):
        ...
        self.result_topic = rospy.get_param('~result_topic', '/yolov8/detections')

        # Initialize YOLOv8 model
        self.model = YOLO('custom11.pt')  # Load YOLOv8 model (use 'yolov8s.pt', 'yolov8m.pt', etc. as needed)
        ...
        rospy.loginfo("YOLOv8 ROS node initialized. Subscribing to: {}".format(self.image_topic))
...
if __name__ == '__main__':
    try:
        ...
        rospy.logerr("YOLOv8 ROS node interrupted.")
